...
gulp.task('kibana', function(){
  return gulp.src('web/src/kibana/**/*')
    .pipe(gulp.dest('web/site/kibana'))
    ;
});
...
gulp.task('watch', ['clean'], function() {
  ...
  // Watch the kibana source files
  gulp.watch('web/src/kibana/**/*', ['kibana']);
  // Start
  gulp.start('styles', 'html', 'images', 'scripts', 'kibana');
});
